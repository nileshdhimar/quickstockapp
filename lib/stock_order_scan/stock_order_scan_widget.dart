...
export 'stock_order_scan_model.dart';

class StockOrderScanWidget extends StatefulWidget {
  const StockOrderScanWidget({Key? key}) : super(key: key);

  @override
  _StockOrderScanWidgetState createState() => _StockOrderScanWidgetState();
}

class _StockOrderScanWidgetState extends State<StockOrderScanWidget>
    with TickerProviderStateMixin {
  late StockOrderScanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StockOrderScanModel());
