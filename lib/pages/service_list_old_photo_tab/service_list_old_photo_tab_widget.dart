...
import 'service_list_old_photo_tab_model.dart';
export 'service_list_old_photo_tab_model.dart';

class ServiceListOldPhotoTabWidget extends StatefulWidget {
  const ServiceListOldPhotoTabWidget({Key? key}) : super(key: key);

  @override
  _ServiceListOldPhotoTabWidgetState createState() =>
      _ServiceListOldPhotoTabWidgetState();
}

class _ServiceListOldPhotoTabWidgetState
    extends State<ServiceListOldPhotoTabWidget> with TickerProviderStateMixin {
  late ServiceListOldPhotoTabModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ServiceListOldPhotoTabModel());
  }
