...
import 'stock_check_detail_model.dart';
export 'stock_check_detail_model.dart';

class StockCheckDetailWidget extends StatefulWidget {
  const StockCheckDetailWidget({Key? key}) : super(key: key);

  @override
  _StockCheckDetailWidgetState createState() => _StockCheckDetailWidgetState();
}

class _StockCheckDetailWidgetState extends State<StockCheckDetailWidget> {
  late StockCheckDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StockCheckDetailModel());
