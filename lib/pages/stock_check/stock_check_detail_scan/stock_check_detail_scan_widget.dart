...
import 'stock_check_detail_scan_model.dart';
export 'stock_check_detail_scan_model.dart';

class StockCheckDetailScanWidget extends StatefulWidget {
  const StockCheckDetailScanWidget({Key? key}) : super(key: key);

  @override
  _StockCheckDetailScanWidgetState createState() =>
      _StockCheckDetailScanWidgetState();
}

class _StockCheckDetailScanWidgetState
    extends State<StockCheckDetailScanWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StockCheckDetailScanModel());
