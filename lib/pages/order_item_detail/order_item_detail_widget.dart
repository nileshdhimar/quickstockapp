...
export 'order_item_detail_model.dart';

class OrderItemDetailWidget extends StatefulWidget {
  const OrderItemDetailWidget({Key? key}) : super(key: key);

  @override
  _OrderItemDetailWidgetState createState() => _OrderItemDetailWidgetState();
}
...
class _OrderItemDetailWidgetState extends State<OrderItemDetailWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderItemDetailModel());
