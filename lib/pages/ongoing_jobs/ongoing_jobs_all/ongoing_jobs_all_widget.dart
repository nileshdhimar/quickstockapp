...
export 'ongoing_jobs_all_model.dart';

class OngoingJobsAllWidget extends StatefulWidget {
  const OngoingJobsAllWidget({Key? key}) : super(key: key);

  @override
  _OngoingJobsAllWidgetState createState() => _OngoingJobsAllWidgetState();
}

class _OngoingJobsAllWidgetState extends State<OngoingJobsAllWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OngoingJobsAllModel());

    _model.textController ??= TextEditingController(text: '821831');
  }
