...
export 'ongoing_jobs_scanned_del_by_trans_model.dart';

class OngoingJobsScannedDelByTransWidget extends StatefulWidget {
  const OngoingJobsScannedDelByTransWidget({Key? key}) : super(key: key);

  @override
  _OngoingJobsScannedDelByTransWidgetState createState() =>
      _OngoingJobsScannedDelByTransWidgetState();
}

class _OngoingJobsScannedDelByTransWidgetState
    extends State<OngoingJobsScannedDelByTransWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OngoingJobsScannedDelByTransModel());
