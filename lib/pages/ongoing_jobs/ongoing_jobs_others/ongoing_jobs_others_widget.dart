...
import 'ongoing_jobs_others_model.dart';
export 'ongoing_jobs_others_model.dart';

class OngoingJobsOthersWidget extends StatefulWidget {
  const OngoingJobsOthersWidget({Key? key}) : super(key: key);

  @override
  _OngoingJobsOthersWidgetState createState() =>
      _OngoingJobsOthersWidgetState();
}

class _OngoingJobsOthersWidgetState extends State<OngoingJobsOthersWidget>
    with TickerProviderStateMixin {
  late OngoingJobsOthersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OngoingJobsOthersModel());
