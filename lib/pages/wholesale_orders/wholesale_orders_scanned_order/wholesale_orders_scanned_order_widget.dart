...
import 'wholesale_orders_scanned_order_model.dart';
export 'wholesale_orders_scanned_order_model.dart';

class WholesaleOrdersScannedOrderWidget extends StatefulWidget {
  const WholesaleOrdersScannedOrderWidget({Key? key}) : super(key: key);

  @override
  _WholesaleOrdersScannedOrderWidgetState createState() =>
      _WholesaleOrdersScannedOrderWidgetState();
}

class _WholesaleOrdersScannedOrderWidgetState
    extends State<WholesaleOrdersScannedOrderWidget>
    with TickerProviderStateMixin {
  late WholesaleOrdersScannedOrderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WholesaleOrdersScannedOrderModel());
